Feature: FF_US_6561227_Displaying VPA Details and Failure Reasons on Customer 360 Screen
  ...
  @pass @run
  Scenario Outline: To verify that user is able to view Customer Profile under UPI section
    Given User is on Customer 360 Login Page
    And  User should select Domain "<Domain>"
    And User enters UserName "<Username>"
    And User enters Password "<Password>"
  ...
  @pass @run
  Scenario Outline: To verify that details is display when user click on Customer Profile
    Given User is on Customer 360 Login Page
    And  User should select Domain "<Domain>"
    And User enters UserName "<Username>"
    And User enters Password "<Password>"
    ...
    And User should be able to view Bajaj Pay Section
    And Clicks on Bajaj Pay tab Option "UPI"
    And Clicks on Bajaj Pay tab Sub Option "Customer Profile"
    And User should be able to view below details under Customer Profile "Customer Profile" Section under UPI
  ...
  Scenario Outline: To verify that “No Data Available ” message is display if No Data Available
    ...
    And Clicks on Bajaj Pay tab Option "UPI"
    And Clicks on Bajaj Pay tab Sub Option "Customer Profile"
    Then "No Data Available" message should be displayed for Customer Profile of UPI when no data available
