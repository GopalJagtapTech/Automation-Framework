Feature: FF_6485717: SOA summarization -  UI Change Requirement
  ...
  @pass
  Scenario Outline: To verify that Loan insights widget is display  for non -cashier profile
    Given User is on Customer 360 Login Page
    And  User should select Domain "<Domain>"
    And User enters UserName "<Username>"
    And User enters Password "<Password>"
    ...
    And Clicks on "PROCEED" Button
    Then User should be redirected to Dashboard Page "<Dashboard>"
    And "Insights" Button should not be displayed for Non Cashier Profile
  ...
  Scenario Outline: To verify that user is able to view Loan Insights CTA on the top-right corner of the dashboard
    ...
    And Clicks on "PROCEED" Button
    Then User should be redirected to Dashboard Page "<Dashboard>"
    And User should be able to view Loan "Insights" CTA on the top-right corner of the dashboard
  ...
  @pass
  Scenario Outline:To verify that user is able to view “I button” under last 5 EMI status on the tile , related C, B & P status
    Given User is on Customer 360 Login Page
    And  User should select Domain "<Domain>"
    And User enters UserName "<Username>"
    And User enters Password "<Password>"
    ...
    And Click on Loan "Insights" CTA on the top-right corner of the dashboard
    Then User should be able to slide-over panel showing customer’s loan summary details
    Then User should be  able to view “I button” under last 5 EMI status on the tile, related C, B & P status
  ...
  @pass
  Scenario Outline:To verify that user is now able to view “Balance /Total Tenure” instead of 'Balance Tenure
    Given User is on Customer 360 Login Page
    And  User should select Domain "<Domain>"
    And User enters UserName "<Username>"
    And User enters Password "<Password>"
    ...
    Then Customer should be able to view below Icons for the "SOA"
    And User should be able to slide-over panel showing customer’s loan summary details
    Then User should be able to view below loan insights details "Balance/ Total Tenure" under tile "P94CPNT10735528"
    Examples:
      | Domain | Username | Password     | Url                                            | Dashboard                                        |
      | CC     | 11075rg  | Finserv_2025 | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard |

  @pass
  Scenario Outline: To verify that user is now able to view “Other Receivables” instead of 'Other Charge
    Given User is on Customer 360 Login Page
    And  User should select Domain "<Domain>"
    And User enters UserName "<Username>"
    And User enters Password "<Password>"
    ...
    Then Customer should be able to view below Icons for the "SOA"
    And User should be able to slide-over panel showing customer’s loan summary details
    Then User should be able to view below loan insights details "Other Receivables" under tile "P94CPNT10735528"
  ...
  @pass
  Scenario Outline: To verify that user is able to view mon-yyyy format under EMI status
    Given User is on Customer 360 Login Page
    And  User should select Domain "<Domain>"
    And User enters UserName "<Username>"
    And User enters Password "<Password>"
    ...
    Then Customer should be able to view below Icons for the "SOA"
    And User should be able to slide-over panel showing customer’s loan summary details
    Then User should be able to view mon-yyyy format under month field on EMI Status for tile "P94CPNT10735528"
